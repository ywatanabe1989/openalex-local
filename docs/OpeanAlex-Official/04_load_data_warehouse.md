...
> **Note**: Several users have contributed more self-contained scripts for this. We haven't tested these but they may be easier options:
> * <https://github.com/naustica/openalex>
> * <https://github.com/DrorSh/openalex_to_gbq>

> **Note**: [Snowflake](https://www.snowflake.com/) users can connect to a ready-to-query data set on the marketplace, helpfully maintained by [Util](https://www.util.co/) - <https://app.snowflake.com/marketplace/listing/GZT0ZOMX4O7>
...
> **Note**: See the full documentation for the `bq load` command here: <https://cloud.google.com/bigquery/docs/reference/bq-cli-reference#bq_load>
...
> **Note**: This step is slow. *How* slow depends on your upload speed, but for `Author` and `Work` we're talking hours, not minutes.
>
