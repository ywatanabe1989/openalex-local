...
> **Warning**: This is hard. Working with such a big and complicated dataset hardly ever goes according to plan. If it gets scary, try the [REST API](https://docs.openalex.org/how-to-use-the-api/api-overview). In fact, try the REST API first. It can answer most of your questions and has a much lower barrier to entry.
...
Up next: the snapshot [data format](01_data_format.md), [downloading the data](02_download.md) and [getting it into your database](03_upload_overview.md).
